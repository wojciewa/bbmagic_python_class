    ...
    def bbm_bt_read_json(self):
        ...
        if i > 0 :
            ...
            if device_type == self.BBMAGIC_M_METEO :
                ...
                d['work_time'] = self.bbm_buf_bytes[self.BBM_METEO_WORKTIME_3] <<24 | self.bbm_buf_bytes[self.BBM_METEO_WORKTIME_2] <<16 | self.bbm_buf_bytes[self.BBM_METEO_WORKTIME_1] <<8 | self.bbm_buf_bytes[self.BBM_METEO_WORKTIME_0]
                ...
                d['meteo_temp'] = "{:4.2f}".format(float(self.bbm_buf[self.BBM_METEO_TEMPER_MSB] <<8 | self.bbm_buf[self.BBM_METEO_TEMPER_LSB]) / 100.0)
                d['meteo_hum'] = self.bbm_buf[self.BBM_METEO_HUM]
                d['adc1'] = "{:4.3f}".format(float(self.bbm_buf[self.BBM_METEO_ADC_1_MSB] <<8 | self.bbm_buf[self.BBM_METEO_ADC_1_LSB]) / 1000.0)
                d['adc2'] = "{:4.3f}".format(float(self.bbm_buf[self.BBM_METEO_ADC_2_MSB] <<8 | self.bbm_buf[self.BBM_METEO_ADC_2_LSB]) / 1000.0)

            elif device_type == self.BBMAGIC_M_MOTION :
                d['type_name'] = 'bbm_motion'
                d['work_time'] = self.bbm_buf_bytes[self.BBM_MOTION_WORKTIME_3] <<24 | self.bbm_buf_bytes[self.BBM_MOTION_WORKTIME_2] <<16 | self.bbm_buf_bytes[self.BBM_MOTION_WORKTIME_1] <<8 | self.bbm_buf_bytes[self.BBM_MOTION_WORKTIME_0]
                ...
                d['adc1'] = "{:4.3f}".format(float(self.bbm_buf[self.BBM_MOTION_ADC_1_MSB] <<8 | self.bbm_buf[self.BBM_MOTION_ADC_1_LSB]) / 1000.0)
                d['adc2'] = "{:4.3f}".format(float(self.bbm_buf[self.BBM_MOTION_ADC_2_MSB] <<8 | self.bbm_buf[self.BBM_MOTION_ADC_2_LSB]) / 1000.0)

            elif device_type == self.BBMAGIC_M_BUTTON :
                d['type_name'] = 'bbm_button'
                d['button_sign'] = self.bbm_buf_bytes[self.BBM_BUTTON_SIGN_3] <<24 | self.bbm_buf_bytes[self.BBM_BUTTON_SIGN_2] <<16 | self.bbm_buf_bytes[self.BBM_BUTTON_SIGN_1] <<8 | self.bbm_buf_bytes[self.BBM_BUTTON_SIGN_0]
                ...
                d['work_time'] = self.bbm_buf_bytes[self.BBM_FLOOD_WORKTIME_3] <<24 | self.bbm_buf_bytes[self.BBM_FLOOD_WORKTIME_2] <<16 | self.bbm_buf_bytes[self.BBM_FLOOD_WORKTIME_1] <<8 | self.bbm_buf_bytes[self.BBM_FLOOD_WORKTIME_0]
                ...
                d['work_time'] = self.bbm_buf_bytes[self.BBM_MAGNETO_WORKTIME_3] <<24 | self.bbm_buf_bytes[self.BBM_MAGNETO_WORKTIME_2] <<16 | self.bbm_buf_bytes[self.BBM_MAGNETO_WORKTIME_1] <<8 | self.bbm_buf_bytes[self.BBM_MAGNETO_WORKTIME_0]
                ...
                d['adc1'] = "{:4.3f}".format(float(self.bbm_buf[self.BBM_MAGNETO_ADC_1_MSB] <<8 | self.bbm_buf[self.BBM_MAGNETO_ADC_1_LSB]) / 1000.0)
                d['adc2'] = "{:4.3f}".format(float(self.bbm_buf[self.BBM_MAGNETO_ADC_2_MSB] <<8 | self.bbm_buf[self.BBM_MAGNETO_ADC_2_LSB]) / 1000.0)

            elif device_type == self.BBMAGIC_M_RELAY :
                d['type_name'] = 'bbm_relay'
                d['work_time'] = self.bbm_buf_bytes[self.BBM_RELAY_WORKTIME_3] <<24 | self.bbm_buf_bytes[self.BBM_RELAY_WORKTIME_2] <<16 | self.bbm_buf_bytes[self.BBM_RELAY_WORKTIME_1] <<8 | self.bbm_buf_bytes[self.BBM_RELAY_WORKTIME_0]
                ...
                d['adc1'] = "{:4.3f}".format(float(self.bbm_buf[self.BBM_RELAY_ADC_1_MSB] <<8 | self.bbm_buf[self.BBM_RELAY_ADC_1_LSB]) / 1000.0)
                d['adc2'] = "{:4.3f}".format(float(self.bbm_buf[self.BBM_RELAY_ADC_2_MSB] <<8 | self.bbm_buf[self.BBM_RELAY_ADC_2_LSB]) / 1000.0)

            elif device_type == self.BBMAGIC_M_DIMMER :
                d['type_name'] = 'bbm_dimmer'
                d['work_time'] = self.bbm_buf_bytes[self.BBM_DIMMER_WORKTIME_3] <<24 | self.bbm_buf_bytes[self.BBM_DIMMER_WORKTIME_2] <<16 | self.bbm_buf_bytes[self.BBM_DIMMER_WORKTIME_1] <<8 | self.bbm_buf_bytes[self.BBM_DIMMER_WORKTIME_0]
                ...
                d['adc1'] = "{:4.3f}".format(float(self.bbm_buf[self.BBM_DIMMER_ADC_1_MSB] <<8 | self.bbm_buf[self.BBM_DIMMER_ADC_1_LSB]) / 1000.0)

            elif device_type == self.BBMAGIC_M_LINUXDEVICE :
                d['type_name'] = 'bbm_linux'
                d['linux_timestamp'] = self.bbm_buf_bytes[self.BBM_LINUXLIB_TIMESTAMP_3] <<24 | self.bbm_buf_bytes[self.BBM_LINUXLIB_TIMESTAMP_2] <<16 | self.bbm_buf_bytes[self.BBM_LINUXLIB_TIMESTAMP_1] <<8 | self.bbm_buf_bytes[self.BBM_LINUXLIB_TIMESTAMP_0]
                d['mac'] = self.buf2mac(self.bbm_buf, self.BBM_LINUXLIB_DEST_ADDR_5, self.BBM_LINUXLIB_DEST_ADDR_0)
                d['linux_lib_data'] = self.bbm_buf[BBM_LINUXLIB_DATA_2] <<16 | self.bbm_buf[BBM_LINUXLIB_DATA_1] <<8 | self.bbm_buf[BBM_LINUXLIB_DATA_0]
